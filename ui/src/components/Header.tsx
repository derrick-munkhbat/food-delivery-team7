...
export function Header() {
  return (
    <div className="top-0 z-10 bg-white  h-[57px] justify-between w-full flex gap-5 container mx-auto border px-5 py-5 xl:py-[8px]  xl:px-[24px] ">
      <div className="container font-bold flex gap-8 justify-center items-center">
        <HeaderLogo />
