          ...
          <form action="#" className="flex flex-col space-y-5">
            <div className="flex flex-col space-y-1">
              ...
              <input
                ...
                id="email"
                autoFocus
                className="bg-[#F7F7F8] px-4 py-4  transition duration-300 border border-[#ECEDF0] rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200"
              />
            </div>
            <div className="flex flex-col space-y-1">
              <label
